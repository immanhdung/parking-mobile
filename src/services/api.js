...
export const paymentAPI = {
  ...
  initiateBookingBankTransfer: (d) =>
    api.post("/payments/bank-transfer/booking/initiate", d),
  checkBankTransferStatus: (id) =>
    api.get(`/payments/bank-transfer/${id}/status`),
};
...
export const reportsAPI = {
  ...
  exportSessions: (params) =>
    api.get("/reports/export/sessions", { params, responseType: "blob" }),
};
